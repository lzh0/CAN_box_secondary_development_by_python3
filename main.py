...
def motion_position_mode_init_config(node_id=0x00,move_to_position=0,max_speed=2000,accleration=2000): #驱动器驱动方式：位置模式——初始化
    ...
    602#22,81,60,00,0f,00,00,00
    602#22,83,60,00,0f,00,00,00
    602#22,84,60,00,0f,00,00,00
    602#22,85,60,00,0f,00,00,00

    602#22,7a,60,00,02,00,00,00
    602#22,40,60,00,0f,00,00,00
    602#22,40,60,00,3f,00,00,00
    602#22,41,2f,00,02,00,00,00

    602#40,63,60,00,00,00,00,00
    '''
    SDO_ask_cob_id=0x600
    SDO_camframe_id=hex(SDO_ask_cob_id+node_id) #//注意hex()函数返回的是字符串类型
    SDO_write_CS="22, "   #0x0022 DEFSTRUCT SDO Parameter  
...
def motion_position_mode_set_position(node_id=0x00,set_position=0): #驱动器驱动方式：速度模式——更改当前电机速度
    ...
    send_canframe_data=SDO_write_CS+object_dictionary_Target_velocity_index+"00"+set_position_hex_strings   #//速度设置共计4个字节  #小端模式从左到右，依次为速度的高位到低位
